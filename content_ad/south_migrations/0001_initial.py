...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'content_ad_advertiser', (
        ...
        db.send_create_signal(u'content_ad', ['Advertiser'])

        # Adding model 'Ad'
        db.create_table(u'content_ad_ad', (
            ...
            ('advertiser', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['content_ad.Advertiser'], null=True, blank=True)),
        ))
        db.send_create_signal(u'content_ad', ['Ad'])


    def backwards(self, orm):
        # Deleting model 'Advertiser'
        db.delete_table(u'content_ad_advertiser')

        # Deleting model 'Ad'
        db.delete_table(u'content_ad_ad')
    ...
    models = {
        ...
        u'content_ad.ad': {
            'Meta': {'ordering': "['-date_modified']", 'object_name': 'Ad', '_ormbases': [u'content.CategoryContent']},
            'advertiser': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content_ad.Advertiser']", 'null': 'True', 'blank': 'True'}),
